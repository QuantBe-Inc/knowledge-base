...
<Tabs>
  ...
  <Tab title="LINEARREG">
    ...
    <ResponseField name="Define Results: Forecast" type="" required>
    Select from a dataset saved in the database.
    </ResponseField>

    <ResponseField name="Define Results: Angle” type" type="" required>
    Select from a single value or a list of values
    </ResponseField>

    <ResponseField name="Define Results: Intercept" type="" required>
    Users are required to provide a name for their data.
    </ResponseField>

    <ResponseField name="Define Results: Slope" type="" required>
    Users are required to provide a name for their data.
    </ResponseField>
