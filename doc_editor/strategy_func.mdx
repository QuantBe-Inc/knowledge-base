...
The "Start" function swiftly extracts and customizes stock market data, with a 'New Data' button for easy selection. Choose between Market data or Indicator tabs, set preferred time frames, and define settings for an optimal strategy. The Data Library on the dashboard efficiently organizes named datasets, functions, and indicators, providing a centralized hub for streamlined financial analysis.

<Frame className="mx-auto">
    <img style={{height: "490px"}} src="/images/Strategy_Function/Start_MarketData.svg" /> 
</Frame>


<Frame className="mx-auto">
    <img style={{height: "490px"}} src="/images/Strategy_Function/Start_Indicator.svg" /> 
</Frame>
...
<Frame className="mx-auto">
    <img style={{height: "400px"}} src="/images/Strategy_Function/Get_Data_2.svg" /> 
</Frame>
...
<Frame className="mx-auto">
    <img style={{height: "300px"}} src="/images/Strategy_Function/Compare.svg" /> 
</Frame>
...
<Frame className="mx-auto">
    <img style={{height: "400px"}} src="/images/Strategy_Function/Math.svg" /> 
</Frame>
